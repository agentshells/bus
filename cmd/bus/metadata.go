		...
		Metadata: map[string]interface{}{
			...
			"io.busdk.environment": map[string]interface{}{
				...
				"variables": []map[string]interface{}{
					...
					envVarDefault("BUS_EVENTS_API_URL", "Local Bus Events API URL supplied to child commands when unset; derived from BUS_HOST when BUS_HOST is set.", "http://127.0.0.1:8081/local/v1"),
					...
					envVarDefault("BUS_WORKERS_API_URL", "Local Bus Workers API URL supplied to child commands when unset; derived from BUS_HOST when BUS_HOST is set.", "http://127.0.0.1:8090/local/v1"),
